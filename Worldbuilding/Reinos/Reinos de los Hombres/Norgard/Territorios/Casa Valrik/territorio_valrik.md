# NORGARD — Territorio de la Casa Valrik

## Estado

**CANON EN DESARROLLO**

Este documento reúne el desarrollo progresivo del territorio administrado por la **Casa Valrik**, con **Treskal** como sede principal.

Se irá ampliando y corrigiendo únicamente mediante nuevas decisiones de canon tomadas durante el desarrollo del lore.

---

## 1. Identidad territorial básica

**Gran Casa:** Valrik  
**Sede:** Treskal  
**Ámbito general:** extremo oriental de Norgard
...
La frontera entre los territorios administrados por la **Casa Galdren** y la **Casa Valrik** discurre aproximadamente de norte a sur.

### Tramo meridional

En una parte importante del tramo meridional, la frontera sigue el **gemelo occidental de los Ríos Sareno y Theleno**, conocidos conjuntamente como **Los Gemelos de Treskal**.

Este río actúa como límite natural entre ambos territorios durante buena parte de su curso hacia el sur.

### Tramo septentrional

Al norte de los **Montes Invernos**, donde ese río todavía no existe como cauce utilizable para delimitar el territorio, la frontera continúa como una **frontera terrestre convencional**.

Este tramo no necesita apoyarse en un gran accidente natural continuo.

Su trazado puede quedar reconocido mediante:

- referencias locales del terreno;
- mojones;
- hitos;
- caminos;
- límites administrativos tradicionales;
- accidentes menores.

La geometría exacta de este tramo quedará para cartografía detallada futura.

### Relación con los Montes Invernos

Los **Montes Invernos no constituyen la frontera Galdren-Valrik**.

La frontera los atraviesa aproximadamente en sentido norte-sur.
...
El interior del Bosque Negro **no contiene aldeas ni villas permanentes**.

Su densidad forestal es una de sus características esenciales y explica en parte su propio nombre: es un bosque cerrado, espeso y difícil de habitar como núcleo civil estable.

Dentro del bosque pueden existir instalaciones funcionales vinculadas a su explotación y vigilancia, entre ellas:

- campamentos madereros;
- puestos de guardabosques;
- enclaves Valrik de control forestal;
- refugios de trabajo;
- instalaciones temporales o semipermanentes de explotación y transporte.

Las **aldeas, pueblos y villas** relacionados con la actividad forestal se sitúan en las **inmediaciones y bordes del Bosque Negro**, pero fuera de su interior denso.

Desde esos asentamientos parten trabajadores, guardabosques, convoyes y rutas de extracción hacia el bosque.

Las comunidades locales y concesiones autorizadas pueden aprovechar determinadas zonas y recursos, pero siempre dentro del marco de autoridad Valrik y sin comprometer el abastecimiento estratégico.
...
- Casa **Valrik** como denominación correcta;
- Treskal como sede principal;
